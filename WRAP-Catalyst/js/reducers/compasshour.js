...
import {
  ...
  COMPASS_HOUR_UGRD_GRIDVALUE_CLICK,
  COMPASS_HOUR_VGRD_GRIDVALUE_CLICK,
...
const initialState = {
  ...
  compassHourUgrdGridValueChecked: false,
  compassHourVgrdGridValueChecked: false,
};
...
export default handleActions({
  ...
  [COMPASS_HOUR_UGRD_GRIDVALUE_CLICK]: (state, action) => ({
    ...state,
    compassHourUgrdGridValueChecked: action.payload.checked,
  }),
  [COMPASS_HOUR_VGRD_GRIDVALUE_CLICK]: (state, action) => ({
    ...state,
    compassHourVgrdGridValueChecked: action.payload.checked,
  }),
}, initialState);
