...
import css from '../../../style/seavisibility/menu.css';

const propTypes = {
  actions: PropTypes.object.isRequired,
  seavisibility: PropTypes.object.isRequired,
};

class Menu extends Component {
  static showClick(e, actions) {
    actions.seaVisibilityClick(e.target.checked);
    if (e.target.checked) {
      actions.addLegend('seavisibility');
    } else {
  ...
  render() {
    const {
      actions, seavisibility,
    } = this.props;

    const {
      seaVisibilityChecked,
      subDisabled,
      basetime,
      validtimeidx,
      basetimeidx,
    ...
    return (
      <div className={css.ctrlpanel}>
        <Checkbox
          label={<FormattedMessage id="seavisibility.seavisibility" />}
          checked={seaVisibilityChecked}
        ...
        <SelectField
          ...
          onChange={(event, index, value) => actions.seaVisibilityBasetimeChange(value)}
        >
          {basetimeItems}
        </SelectField>
        <SelectField
          ...
          {...subDisabled}
          style={css.selectTime}
          onChange={(event, index, value) => actions.seaVisibilityValidtimeChange(value)}
        >
          {validtimeItems}
        </SelectField>
      </div>
