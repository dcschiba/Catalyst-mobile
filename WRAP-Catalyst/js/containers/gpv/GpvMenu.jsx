...
const propTypes = {
  ...
  precipitationShow: PropTypes.bool.isRequired,
  precipitationchecked: PropTypes.bool.isRequired,
  gpvprecgroupDisabled: PropTypes.object.isRequired,
  precflatchecked: PropTypes.bool.isRequired,
  precgradationchecked: PropTypes.bool.isRequired,
  snowdepthShow: PropTypes.bool.isRequired,
  snowdepthchecked: PropTypes.bool.isRequired,
  pressuremslShow: PropTypes.bool.isRequired,
  pressuremslchecked: PropTypes.bool.isRequired,
};
  ...
  render() {
      ...
      precipitationdiv = (
        <div>
          ...
          <div className={css.bottomCheckBox}>
            <CheckBox
              checked={precflatchecked}
              onClick={e => actions.gpvPrecipitationFlatClick(e.target.checked)}
              disabled={gpvprecgroupDisabled.disabled}
              label={'Flat'}
            />
            <CheckBox
              checked={precgradationchecked}
              onClick={e => actions.gpvPrecipitationGradationClick(e.target.checked)}
              disabled={gpvprecgroupDisabled.disabled}
              label={'Gradation'}
            />
          </div>
    ...
    if (snowdepthShow) {
      snowdepthdiv = (
        <div>
          <CheckBox
            checked={snowdepthchecked}
            onClick={e => actions.gpvSnowDepthClick(e.target.checked)}
            disabled={gpvDisabled.disabled}
            label={'Snow Depth'}
          />
        </div>
    ...
    if (pressuremslShow) {
      pressuremsldiv = (
        <div>
          <CheckBox
            checked={pressuremslchecked}
            onClick={e => actions.gpvPressureMSLClick(e.target.checked)}
            disabled={gpvDisabled.disabled}
            label={'Pressure (MSL)'}
          />
        </div>
